...
$$('.ehead').on('click', function () {
    myApp.modal({
        ...
        '<div class="item-media"><i class="f7-icons">linked_camera</i></div>' +
        '<div class="item-inner">' +
        '<div class="item-title">拍照</div></div></a></li>' +
        '<li><a href="#" class="item-link item-content photo">' +
        '<div class="item-media"><i class="f7-icons">images</i></div>' +
        '<div class="item-inner">' +
...
setTimeout(function () {
    $$(".comemessage").append('<i class="f7-icons" style="color:red"><sup>star</sup></i>');
    myApp.addNotification({
        title: '提示',
        message: '您收到新通知！'
    });
